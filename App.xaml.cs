...
namespace tp2
{
    ...
    public partial class App : Application
    {
        ...
        public static readonly string ApplicationBaseUri = "pack://application:,,,/Wall/Assets;component";
        ...
        public static Dictionary<int, User> Users = new Dictionary<int, User>()
        {
            ...
            { 1002, new User(1002,"Elliot","Hart","user2.jpg",350) },
            { 1003, new User(1003,"Rachel","Chapman","user3.jpg",350) },
            { 1004, new User(1004,"Myriam","Leblanc","user4.jpg",350) },
            { 1005, new User(1005,"Paul","Burnham","user5.jpg",350) },
        };

        public static Dictionary<int, Post> Posts = new Dictionary<int, Post>()
        {
            { 101,new Post(101,Users[1001],"",new Content(1,"content1",DateTime.Now,"udsfidsf") ) },
            { 102,new Post(102,Users[1001],"",new Content(2,"content2",DateTime.Now,"udsfidsf") ) },
            { 103,new Post(103,Users[1002],"",new Content(3,"content3",DateTime.Now,"udsfidsf") ) },
            { 104,new Post(104,Users[1002],"",new Content(4,"content4",DateTime.Now,"udsfidsf") ) },
            { 105,new Post(105,Users[1003],"",new Content(5,"content5",DateTime.Now,"udsfidsf") ) },
            { 106,new Post(106,Users[1003],"",new Content(6,"content6",DateTime.Now,"udsfidsf") ) },
            { 107,new Post(107,Users[1004],"",new Content(7,"content7",DateTime.Now,"udsfidsf") ) },
            { 108,new Post(108,Users[1004],"",new Content(8,"content8",DateTime.Now,"udsfidsf") ) },
            { 109,new Post(109,Users[1005],"",new Content(8,"content8",DateTime.Now,"udsfidsf") ) },
            { 110,new Post(110,Users[1005],"",new Content(8,"content8",DateTime.Now,"udsfidsf") ) },
        };
